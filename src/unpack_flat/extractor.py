...
from .config import is_archive, DEFAULT_MAX_ROUNDS, DEFAULT_WORKERS
from .sevenzip import extract_archive, check_7z_available, SevenZipNotFoundError
...
class UnpackFlat:
    ...
    def _setup_directories(self) -> None:
        ...
        if not self.dry_run:
            ...
            self.console.print(f"[dim]Copying input to working directory...[/dim]")
